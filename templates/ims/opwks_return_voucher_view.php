...
$items = $connect->prepare("
    ...
    FROM opwks_return_voucher_items vi
...
<html>
<head>
<title>OPWKS Return Voucher</title>
...
<h3>LOAN RENEWAL VOUCHER – <?= date('Y') ?></h3>
<h4>ISSUE, RECEIPT & EXPENSE VOUCHER</h4>
...
<b>ISSUED TO :</b>
<input type="text" class="edit" placeholder="Enter Unit / Store Name">
</p>
...
<p class="center mt-20"><b>( Total Items <?= $count ?> only )</b></p>
...
<a href="opwks_return_voucher_list.php" class="btn btn-secondary">BACK</a>
</div>
