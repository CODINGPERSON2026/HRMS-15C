...
/* FIXED FILTER – REGTL PROPERTIES / OFFR MESS FUND */
$GRANT_TYPE = "REGTL PROPERTIES";
$GRANT_NAME = "OFFR MESS FUND";
...
th:nth-child(3){
    text-align:center;
    font-weight:700;   /* heading center */
}
