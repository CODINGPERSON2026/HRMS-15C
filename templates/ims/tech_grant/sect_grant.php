...
/* FIXED GRANT FILTER – SECT (NO SUB GRANT) */
...
while($row = $result->fetch_assoc()){
    ...
    // ✅ Distribution total hi received banega
    $received = (int)$row['total_issue'];

    // ✅ Available always zero
    $available = 0;

    $cls = 'low-stock'; // since always 0
